...
<body>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <div class="panel panel-primary"> <h2><span class="glyphicon glyphicon-user"> <strong>Quản lý tài khoản</strong></span>  </h2></div>  
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="col-md-9">
        <p>user1</p>      
        <p>***********</p>
        <p>14110427@gmail.com</p>
      </div>     
        </div>
      </div>
  <div class="container">
<button class="btn btn-lg btn-primary btn-block" type="submit"><a href="TrangDoiMatKhau.html"" ><span style="color: white">Đổi mật khẩu</span></a></button>
<button class="btn btn-lg btn-primary btn-block" type="submit"><a href="#" ><span style="color: white">Đổi mail</span></a></button>
</div>
