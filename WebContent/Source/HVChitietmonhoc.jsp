...
<body>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <div > <h2><span > <strong>CHI TIẾT MÔN LẬP TRÌNH WEB </strong></span>  </h2></div>  
...
<div class="row">
  <div class="col-md-12">
      <div class="col-md-6">
       <p>Tên giảng viên: Mark Zuckerberg </p>         
       <p>Tên khoá học: Lập trình web Khoá 14</p>
       <p>Phòng học: A3-304</p>
      </div>
      <div class="col-md-6">
        <p>Thời gian học: Thứ 6 Tiết 1-5</p>   
        <p>Thời gian bắt đầu: 1/9/2016</p>
        <p>Thời gian kết thúc: 1/12/2016</p>
      </div>     
        </div>
      </div>
  <div class="container">
<button class="btn btn-lg btn-primary btn-block" type="submit"><a href="TrangDoiMatKhau.html"" ><span style="color: white">Đăng ký</span></a></button>
