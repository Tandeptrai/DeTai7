  ...
  <section class="tada-container content-posts page post-full-width">
    ...
    <div class="container">
      <div class="col-md-6 col-md-offset-3">
          <h1>Chọn đối tượng để tìm kiếm</h1>
          <br/>
          <br/>
        <label class="col-md-4">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"> Theo Key World</label>
        <label class="col-md-4">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> Theo Thời Gian</label>
        <label class="col-md-4">
          <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3"> Theo Mã Học Viên</label>
          <br/>
          <br/>
              ...
              <div class="search-box"> 
                  ...
                  <input class="form-control" placeholder="Nguyễn Văn A, 14110378, 11/14/2016, Cơ Sở Dữ Liệu" type="text"> 
                   <button><a href ="GV.TrangTKSV.html" class="btn btn-link search-btn"> <span class="glyphicon glyphicon-search"></a></span>
                   </button> 
                  </form>
                  <br/>
              </br/> 
