 ...
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    *******************************************************************************************************************************************-->
    ...
    <section class="tada-container content-posts page post-full-width">
         ...
         <!-- *** CONTENT *** -->
    <div class="alert alert-danger" role="alert"><h3>Một tin nhắn xác thực đã được gởi đến địa chỉ mail của bạn, vui lòng kiểm tra hộp 
     thư đến để xác nhận, trường hợp không thấy trong hộp thư đến, vui lòng kiểm tra trong tin nhắn rắc. Xin cảm ơn!</h3> </div>
       ...
       <hr>
<div>
        <button class="btn btn-lg btn-primary btn-block" type="submit"><a href="TrangHocVien.html" ><span style="color: white">Bấm để quay lại</span></a></button>
