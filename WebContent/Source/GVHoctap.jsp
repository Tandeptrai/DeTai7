  ...
  <section class="tada-container content-posts page post-full-width">
       ...
       <!-- *** CONTENT *** -->
        <div class="col-md-6 col-md-offset-2"> 
           ...
           <h1 id="ThongTinCaNhan" style="clear:right; margin-left:20px;color:#009;">Thêm Bài Tập Mới </h1>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputText" placeholder="Nhập Tên Bài Tập..">
    </div>
...
<div class="form-group">
    <label for="inputText" class="col-sm-4 control-label">Gắn Bài Tập Cho Học Viên</label>
    <div class="col-sm-4">
    ...
    <br>
    <br>
    <a type="button" class="col-sm-3 btn btn-link" href="Video.html">Thêm Video</a>
