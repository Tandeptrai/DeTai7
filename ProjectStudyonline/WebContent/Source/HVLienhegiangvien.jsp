...
<body>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <div class="content col-xs-12">
        ...
        <div class="col-md-12">
            <div class="post-text">
                    <h2>GỬI TIN NHẮN CHO GIẢNG VIÊN</h2>
                </div>  
        </div>
        </div>
        ...
        <article>
                ...
                <div class="comment-form">
                  ...
                  <form method="post" id ="contactform" action="" role="form">
                    ...
                    <input type="text" class="form-control" id="contactsubject"  placeholder="Nhập chủ đề">
                    </div>
                    ...
                    <button type="button" id="contactbtn" class="btn btn-default">Gửi</button>
...
$(document).ready(  
    ...
    $("#contactbtn").click(function()
            {
                validateText("contactemail");
                validateText("contactsubject");
                validateText("contactmessage");
            });
    }
);
