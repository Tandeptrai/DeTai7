...
<body>
    	...
    	<nav class="menu-desktop menu-sticky">  
            ...
            <ul class="tada-menu">
                    ...
                    <li><a href="#">DANH MỤC PHẢN HỒI <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                        	<li><a href="#">TIN NHẮN PHẢN HỒI CỦA HV</a></li>
    ...
    *******************************************************************************************************************************************-->
	...
	<section class="tada-container content-posts page post-full-width">
        ...
        <div class="col-md-12">
            <div class="post-text">
<h2 align="center">Danh Sách Tin Nhắn Phản Hồi Của Học Viên</h2>
<div class="container">
  <div class="row">
    <div class="col-md-10">
        ...
        <div class="panel-body">
          <ul class="list-group">
            <li class="list-group-item">
              ...
              <div class="pull-right action-buttons"  id ="Btn3"data-toggle="tooltip" data-placement="auto top" title="1 tin nhắn mới"> <a><span class="glyphicon glyphicon-envelope"></span></a>
...
<div class="modal fade" id="myModal3" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h3 class="modal-title">Phản hồi tin nhắn cho học viên</h3>
        </div>
        <form>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form>
          ...
          <div class="form-group">
            <label  >Tiêu đề:</label>
            <p class="form-control" > đánh giá chất lượng </p>
          </div>
           <div class="form-group">
            <lable class="control-label">Nội dung tin nhắn:</lable>
             <p class="form-control">Chất lượng trang web tạm được ad cần thêm nhiều tính năng hơn và giao diện hơn nữa 
          </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
        <button type="button" class="btn btn-primary">Gửi</button>
