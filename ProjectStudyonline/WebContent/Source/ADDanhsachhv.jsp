        ...
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col col-xs-6 text-right">
              <button id="myBtn" class="btn btn-sm btn-primary btn-create">Thêm mới</button>
            </div>
...
<label>Mã số học viên</label>
 <input id="maso" name="password" type="password" placeholder="Vui lòng nhập mã số học viên" required>
 </div>
 <div class = "form-group">
 <label>Họ Tên</label>
          ...
          <table class="table table-striped table-bordered table-list">
            <thead>
              <tr>
                ...
                <th class="hidden-xs">Mã số học viên</th>
                <th>Họ tên</th>
                <th>Chức năng </th>
                <th>Email</th>
              </tr>
            ...
            <tbody>
              <tr>
                <td align="center"><button id="Btn2" class="btn btn-default"  data-toggle="tooltip" data-placement="auto top" title="Sửa" >
	<a class="fa fa-pencil"></a></button> 
	<button id = "Btn" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Xóa"><em class="fa fa-trash"></em></button>
                </td>
   ...
   <div class="modal-dialog" role="document">
     ...
     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h2 ><p>	BẠN CÓ MUỐN XÓA HỌC VIÊN NÀY KHÔNG</p></h2>
      </div>
      <div class="modal-footer">
...
<label>Mã số học viên</label>
 ...
 <div class = "form-group">
 <label>Họ Tên</label>
<p class="form-control-static"> Trần Việt Tấn</p>
 </div>
 <div class = "form-group">
 <label >Email</label>
<p class="form-control-static">tandeptrai@gmail.com</p>
 </div>
<div>
<b><p class="help-block"> Chức năng phân quyền : </p></b>
</div>	
