    ...
    <header class="tada-container">
    	...
    	<nav class="menu-desktop menu-sticky">
            ...
            <ul class="tada-menu">
                    ...
                    <li><a href="#">DANH SÁCH CÁC KHÓA HỌC </a>
        ...
        <div class="col-md-12">
            <div class="post-text">
                    <h1>CHÀO MỪNG BẠN ĐẾN VỚI TRANG HỖ TRỢ HỌC TRỰC TUYẾN</h1>
                </div>  
        </div>
        </div>
        <article>
    	...
    	<div class="content col-xs-12">
        	...
        	<article>
            	<div class="post-image">
                	<img src="../img/book2.jpg" alt="post image 2">
                    
                </div>
                <div class="post-text">
                	
                    <h2><a href="#">KHO TÀI LIỆU PHONG PHÚ</a></h2>
                    <p class="text">MỘT SỐ LƯỢNG TÀI LIỆU ĐA DẠNG PHONG PHÚ ĐƯỢC CÁC GIẢNG VIÊN CHẮT LỌC ĐẢM BẢO KIẾN THỨC VŨNG VÀNG.
        	...
        	<article>
                ...
                <div class="post-text">
                    ...
                    <h2><a href="#">ĐỘI NGŨ GIẢNG VIÊN HÀNG ĐẦU</a></h2>
                    <p class="text">VỚI ĐỘI NGŨ GIẢNG VIÊN GIÀU KINH NGHIỆM, TẬN TÂM, NHIỆT HUYẾT TRONG VIỆC GIẢNG DẠY.
                                    <a href="#"><i class="icon-arrow-right2"></i></a></p>                                 
                </div>
                <div class="post-info">
        	...
        	<article>
            	<div class="post-image">
                	<img src="../img/hcmute.jpg" alt="post image 4">
                    
                </div>
                <div class="post-text">
                	
                    <h2><a href="#">HỆ THỐNG QUẢN LÝ CHẤT LƯỢNG</a></h2>
                    <p class="text">VỚI HỆ THỐNG QUẢN LÝ CHẤT LƯỢNG VÀ ĐỘI NGŨ QUẢN TRỊ VIÊN NHIỆT TÌNH GIẢI ĐÁP CÁC VẤN ĐỀ THẮC MẮC TỪ 
                    CÁC HỌC VIÊN.
                                    <a href="#"><i class="icon-arrow-right2"></i></a></p>                                 
                </div>
                <div class="post-info">
                	<div class="post-by">Post By <a href="#">GROUP 4</a></div>
                    <div class="extra-info">
                    	<a href="#"><i class="icon-facebook5"></i></a>
                		<a href="#"><i class="icon-twitter4"></i></a>
                		<a href="#"><i class="icon-google-plus"></i></a>
...
<!-- Mirrored from themes.ad-theme.com/html/tada/home-1-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2016 06:56:04 GMT -->
</html>
